...
class Manager:
    ...
    def __init__(self , file):
        ...
        self.all_samples[ '03SignalMGPythia500' ] = SampleList( 'SignalMGPythia500' , {} , ['/GJets_Mjj-500.*pythia.*' , '/GJets_Mjj-500.*(?P<interference>_INTERFERENCE_).*pythia.*'] )
        self.all_samples[ '04SignalMGPythia120' ] = SampleList( 'SignalMGPythia120' , {} , ['/GJets_SM_5f.*EWK.*pythia.*' , '/GJets_SM_5f.*(?P<interference>_INTERFERENCE_).*pythia.*'] )
        self.all_samples[ '05SignalMGHerwig120' ] = SampleList( 'SignalMGHerwig120' , {} , ['/GJets_SM_5f.*EWK.*herwig.*' , '/GJets_SM_5f.*(?P<interference>_INTERFERENCE_).*herwig.*'] )
        self.all_samples[ '06SignalNLOPythia' ] = SampleList( 'SignalNLOPythia' , {} , ['/AJJ_EWK.*'] )
        ...
        self.all_samples[ '10DYJetsMG' ] = SampleList( 'DYJetsLO' , {'htrang', 'mrange' } , [ '/DYJetsToLL_M-(?P<mrange>[^_]*)_HT-(?P<htrange>[^_]*)_.*madgraphMLM.*']  , 'htrange')
        ...
        self.all_samples[ '15ttjets' ] = SampleList('TTJets' , {} , [ '/TTJets.*' ] )
