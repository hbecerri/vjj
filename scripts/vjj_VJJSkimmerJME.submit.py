...
def main():
    ...
    parser.add_argument('--baseoutdir' , dest='baseoutdir' , help='the base directory to write output files' , default='.' , type=str) #'/eos/cms/store/cmst3/group/top/SMP-19-005')
    ...
    parser.add_argument('--flavour', dest='flavour',   help='job-flavour',  default='1nd' , choices=['8nm' , '1nh' , '8nh' , '1nd' , '2nd' , '1nw' , '2nw'], type=str)
